...
public class LabTask1 {
    public static void main(String[] args) {
        ...
        System.out.printf("%-15s %-15d %-15d %-15s\n", "char", Character.SIZE, Character.BYTES, "from " + (int) Character.MIN_VALUE + " to " + (int) Character.MAX_VALUE);
        System.out.printf("%-15s %-15d %-15d %-15s\n", "double", Double.SIZE, Double.BYTES, "from " + Double.MIN_VALUE + " to " + Double.MAX_VALUE);
        System.out.printf("%-15s %-15s %-15s %-15s\n", "boolean", "1", "\"size\" isn't something that's precisely defined", "has " + true + " and " + false);
    }
}
